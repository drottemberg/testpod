...
typedef NS_ENUM(NSUInteger, G8OCREngineMode){
    ...
    G8OCREngineModeTesseractOnly,           // Run Tesseract only - fastest
    G8OCREngineModeLSTMOnly,                // Run just the LSTM line recognizer.
    G8OCREngineModeTesseractLSTMCombined,  // Run the LSTM recognizer, but allow fallback
    // to Tesseract when things get difficult.
    G8OCREngineModeDefault,                  // Specify this mode when calling init_*(),
    ...
    G8OCREngineModeCubeOnly,                // Run Cube only - better accuracy, but slower
